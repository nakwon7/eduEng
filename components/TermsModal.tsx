    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-gray-950">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 space-y-10 text-sm">
        ...
        <section className="space-y-5">
          ...
          <div className="space-y-1">
            <h3 className="font-semibold text-gray-200 text-xs">5. 개인정보의 국외 이전</h3>
            <p className="text-gray-400 text-xs leading-relaxed">회사는 서비스 운영을 위해 아래와 같이 개인정보를 국외로 이전하여 처리하고 있습니다.</p>
            <ul className="text-gray-400 text-xs leading-relaxed space-y-1 list-disc list-inside">
          ...
          <div className="space-y-1">
            <h3 className="font-semibold text-gray-200 text-xs">6. 이용자 권리</h3>
          ...
          <div className="space-y-1">
            <h3 className="font-semibold text-gray-200 text-xs">7. 개인정보 보호책임자</h3>
