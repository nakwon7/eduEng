      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 space-y-10 text-sm">
        ...
        <section className="space-y-5">
          ...
          <div className="space-y-1">
            ...
            <ul className="text-gray-400 text-xs leading-relaxed space-y-1 list-disc list-inside">
              <li>Free Trial: 10 minutes total, free to use within 1 week of sign-up, no payment required</li>
              <li>Membership: $3/week, paid via bank transfer or PayPal</li>
          ...
          <div className="space-y-1">
            ...
            <ul className="text-gray-400 text-xs leading-relaxed space-y-1 list-disc list-inside">
              <li>As 10 minutes of free trial time are provided immediately upon sign-up, refunds are not available after membership payment.</li>
